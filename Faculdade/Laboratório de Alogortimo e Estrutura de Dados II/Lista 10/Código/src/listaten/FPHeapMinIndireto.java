 ...
 */
  ...
  public void refaz (int esq, int dir) {//Método que é chamado na construção do Heap    
    int j = esq * 2;
    int x = this.fp[esq];
    while (j <= dir) {
  ...
  public void constroi () {//Constrói o Heap
    int esq = n / 2 + 1;
    while (esq > 1) { 
        esq--; 
  ...
  public int retiraMin () throws Exception {//Método que percorre o Heap
    int minimo;
    if (this.n < 1) 
